...
import xyz.hans.customview.R;

/**
 * Created by Hans on 16/11/5
 * <p>
 * 基于https://github.com/hdodenhof/CircleImageView
 * 在外部添加一个圆形的倒数进度条
 */
public class CircleProgressImageView extends ImageView {
    ...
    private static final int DEFAULT_PROGRESS_DURATION = 0;
    ...
    private int mProgressDuration = DEFAULT_PROGRESS_DURATION;
    ...
    public CircleProgressImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mProgressColor = a.getColor(R.styleable.CircleImageView_civ_progress_color, DEFAULT_PROGRESS_COLOR);
        mProgressWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_progress_width, DEFAULT_BORDER_WIDTH);
        mProgressDuration = a.getInt(R.styleable.CircleImageView_civ_progress_duration, DEFAULT_PROGRESS_DURATION);
        a.recycle();
    ...
    private void initAnimator() {
        ...
        if (mProgressWidth != 0) {
            ...
            valueAnimator.setDuration(mProgressDuration);
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    if (mOnProgressListener != null) mOnProgressListener.onProgress(mCurrentRadius);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mRectF == null) {
            ...
            mRectF = new RectF(mProgressWidth, mProgressWidth, right - left - mProgressWidth, right - left - mProgressWidth);
        }
